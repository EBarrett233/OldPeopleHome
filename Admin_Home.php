...
<form>
    ...
    $num=0;
    $sql="SELECT Role,F_Name,L_Name FROM Patients_Home WHERE Mor_Med ='no' OR Aft_Med ='no' OR Night_Med ='no' OR Night_Med='Breakast' OR Night_Med='Lunch' OR Night_Med='Dinner' ";
    $ret= pg_query($db, $sql);
